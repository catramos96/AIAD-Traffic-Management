...
public class Map extends Agent 
{
	...
	public Map() {
	    ...
	    Road r5 = new Road(new Point(5,12), new Point(8,12),i8,i9);
	    Road r6 = new Road(new Point(11,12), new Point(18,12),i10,i11);
	    Road r7 = new Road(new Point(3,11), new Point(8,11),i12,i13);
	    Road r8 = new Road(new Point(11,11), new Point(15,11),i14,i15);
	    ...
	    Road r14= new Road(new Point(9,13),new Point(9,16),i5,i9);
	    Road r15= new Road(new Point(9,10), new Point(9,8),i13,i17);
	    Road r16= new Road(new Point(10,14), new Point(10,13),i6,i10);
	    Road r17= new Road(new Point(10,2),new Point(10,10),i14,i18);
